...
//         console.error('Doctor information is not available or slots_booked is undefined.');
//         return;
//     }

//     setSlots([]); // Clear existing slots

//     let today = new Date(); // Current date
//     let allTimeSlots = []; // Temporary array to hold all available slots

//     for (let i = 0; i < 7; i++) { // Getting dates for the next 7 days
//         let currentDate = new Date(today);
//         currentDate.setDate(today.getDate() + i);
...
//             currentDate.setMinutes(currentDate.getMinutes() > 30 ? 30 : 0); // 30 minutes interval
//         } else {
//             currentDate.setHours(10);
//             currentDate.setMinutes(0);
//         }
...
//         allTimeSlots.push(...timeSlots); // Collect all available slots
//     }

//     setSlots(allTimeSlots); // Set the state once after the loop
// };

// useEffect(() => {
//     if (docInfo) {
//         availableSlots(); // Fetch available slots when docInfo changes
//     }
// }, [docInfo]);
  ...
  return docInfo && (
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className=" flex-1 border border-gray-700 rounded-lg p-8 py-7">
          ...
          <div className=" ">
            ...
            <p className='flex flex-col sm:flex-row mt-4 gap-2'> Appointment Fee :  </p>
      ...
      <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
        ...
        <button onClick={bookAppointment} className='bg-slate-900 text-white text-sm font-light px-10 py-3 rounded-full my-6 ' >Book an appointment</button>
      </div>
